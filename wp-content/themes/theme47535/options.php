...
$typography_mixed_fonts["Racing Sans One, cursive"] = "Racing Sans One *";
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#b9b9b9'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '24px', 'face' => 'Racing Sans One, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#484848'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '45px', 'lineheight' => '45px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#484848'));
			...
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '10px', 'lineheight' => '12px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#525252'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '35px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffd070'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '30px', 'face' => 'Racing Sans One, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#484848'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '10px', 'lineheight' => '10px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#525252'));
